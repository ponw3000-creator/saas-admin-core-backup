...
export const chatSessionsMockData = [
  {
    ...
    status: '在线',
    channel_id: 1,
    sourceDetail: '男装小程序 - 微信入口',
    currentPageDetail: '【2024夏季新款】男士速干运动T恤',
    lastMsg: '我想咨询产品报价',
    time: '刚刚',
  ...
  },
  {
    ...
    status: '在线',
    channel_id: 3,
    sourceDetail: '官方App - iOS客户端',
    currentPageDetail: '【企业版套餐】功能对比表',
    lastMsg: '退款申请审核进度',
    time: '10:32',
  ...
  },
  {
    ...
    status: '离线',
    channel_id: 2,
    sourceDetail: '京东旗舰店 - PC端',
    currentPageDetail: '【退换货政策】详情页',
    lastMsg: '发票怎么开具',
    time: '09:15',
  ...
  },
  {
    ...
    status: '在线',
    channel_id: 5,
    sourceDetail: '抖音直播间 - 短视频入口',
    currentPageDetail: '【会员权益】升级专区',
    lastMsg: '会员如何升级',
    time: '昨天',
  ...
  },
  {
    ...
    status: '离线',
    channel_id: 4,
    sourceDetail: '支付宝小程序 - 生活号',
    currentPageDetail: '【账户安全】找回密码页',
    lastMsg: '密码忘了怎么办',
    time: '昨天',
